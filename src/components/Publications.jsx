    ...
    <div className="space-y-6">
        ...
        <div className="bg-blue-50 rounded-lg p-3">
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div className="text-center">
              <div className="font-bold text-blue-600">{publicationsData.stats.totalPapers}</div>
              <div className="text-gray-600">Total Papers</div>
            </div>
            <div className="text-center">
              <div className="font-bold text-blue-600">{publicationsData.stats.citations}</div>
      ...
      <div className="space-y-6">
        {publicationsData.publications.map((pub, index) => (
          <div key={pub.id} className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow duration-200">
            <div className="flex justify-between items-start mb-3">
              <h3 className="font-semibold text-gray-800 text-lg leading-tight pr-4">{pub.title}</h3>
            ...
            {pub.abstract && (
              <div className="bg-gray-50 rounded p-3 mb-4">
                <h4 className="font-medium text-gray-800 mb-1">Abstract:</h4>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="space-x-2">
                <a href={pub.paperUrl} className="text-blue-600 text-sm hover:underline">Paper</a>
                <a href={pub.codeUrl} className="text-blue-600 text-sm hover:underline">Code</a>
                <button 
